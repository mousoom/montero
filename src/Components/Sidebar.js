      ...
      <div className={classes.root}>
        ...
        <nav className={classes.drawer} aria-label="mailbox folders">
          ...
          <Hidden smUp implementation="css">
            ...
            >
              <div>
              <div style={{display:'flex',alignItems:'center',height:'90px',padding:"0px 0px 0px 25px"}}>
                  <img src={Logo} style={{width:'55px'}} alt="logo"/>
                  <Typography style={{fontFamily: 'Comfortaa',fontWeight:'700',fontSize:'20px', paddingLeft:'5px',color:'#00ab55'}}>montero</Typography>
               </div>
                {user && (
                  <Box
                  style={{
                ...
                >
                  ...
                  />
                  <div>
                    <Typography style={{fontWeight:'600',fontSize:'0.875rem'}}>{user.username}</Typography>
                    <Typography style={{fontSize:'0.875rem',fontWeight:'400',textTransform:'lowercase'}}>{user.userType}</Typography>
                  </div>
                </Box>
                )}
